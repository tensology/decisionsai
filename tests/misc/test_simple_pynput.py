...
"""
Simple test to see if pynput listeners work in a separate thread.
"""
...
def test_pynput_in_thread():
    """Test if pynput listeners work in a separate thread"""
    print("Starting pynput listeners in separate thread...")
