...
def test_google_email_adapter_searches_and_downloads_attachments():
    from distr.core.hermes_delegated.adapters import GoogleEmailAdapter
...
def test_project_cli_dispatcher_returns_blocker_without_project_id():
    from distr.core.hermes_delegated.adapters import ProjectCliDispatcher
...
def test_direct_desktop_adapter_uses_clipboard_and_filesystem(tmp_path):
    from distr.core.hermes_delegated.adapters import DirectDesktopAdapter
...
def test_playwright_browser_adapter_generates_navigation_script_for_url():
    from distr.core.hermes_delegated.adapters import PlaywrightBrowserAdapter
