...
def test_parse_delegated_continuation_intent_recognizes_retry_and_route():
    from distr.core.delegated_workflow.continuation import parse_delegated_continuation_intent
...
def test_record_delegated_continuation_links_latest_run_and_redacts(monkeypatch):
    from distr.core.delegated_workflow.continuation import (
...
def test_find_latest_delegated_run_report_filters_newest_report(monkeypatch):
    from distr.core.delegated_workflow.continuation import find_latest_delegated_run_report
    ...
    monkeypatch.setattr("distr.core.orchestrator.list_events", lambda **kwargs: events)
