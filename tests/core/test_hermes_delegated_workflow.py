...
def test_roadblock_report_formats_options_for_telegram():
    from distr.core.hermes_delegated.models import Roadblock
    from distr.core.hermes_delegated.roadblocks import format_telegram_report
...
def test_run_report_formats_completed_and_blocked_for_telegram():
    ...
    from distr.core.hermes_delegated.planner import plan_delegated_workflow
    from distr.core.hermes_delegated.roadblocks import build_roadblock_report, format_run_report_for_telegram
...
def test_record_delegated_plan_emits_redacted_hermes_event(monkeypatch):
    ...
    emitted = []
    monkeypatch.setattr("distr.core.hermes.emit_event", lambda **kwargs: emitted.append(kwargs) or 123)
...
def test_record_delegated_run_report_emits_redacted_hermes_event(monkeypatch):
    ...
    emitted = []
    monkeypatch.setattr("distr.core.hermes.emit_event", lambda **kwargs: emitted.append(kwargs) or 124)
