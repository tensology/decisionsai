...
and context_rules is empty or None.
...
# step_title and workflow_description are irrelevant for single-step passthrough
# but we still generate them to ensure they don't leak into the output.
...
def test_single_step_returns_raw_instruction(
    ...
    empty, and context_rules is empty or None, build_step_context_prompt()
    SHALL return the raw step instruction unchanged."""
