...
@patch("distr.core.hermes.emit_event")
@patch("distr.core.hermes_orchestrator._call_orchestrator_llm", return_value=None)
@patch("distr.core.hermes.inspect_visual_baseline_readiness", return_value={"ready": True, "verdict": "pass"})
@patch("distr.core.project_cli_backends.get_backend")
@patch("distr.core.kanban.ticket_policy.resolve_ticket_cli_route")
...
@patch("distr.core.hermes.record_routing_override")
@patch("distr.core.hermes.emit_event")
@patch("distr.core.hermes_orchestrator._call_orchestrator_llm", return_value=None)
@patch("distr.core.project_cli_backends.get_backend")
@patch("distr.core.kanban.ticket_policy.resolve_ticket_cli_route")
...
@patch("distr.core.hermes.emit_event")
@patch("distr.core.hermes_orchestrator._call_orchestrator_llm", return_value=None)
@patch("distr.core.hermes.build_visual_taste_context", return_value="[VISUAL TASTE MEMORY]\n- approved: Dense operational layouts.")
@patch("distr.core.hermes.build_learned_rules_context", return_value="[BOARD LEARNED RULES]\n- Validate browser flows.")
@patch("distr.core.project_cli_backends.get_backend")
@patch("distr.core.kanban.ticket_policy.resolve_ticket_cli_route")
