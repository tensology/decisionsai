...
def test_preflight_reports_ready_email_document_handoff_stack():
    from distr.core.delegated_workflow.preflight import preflight_delegated_plan
...
def test_record_delegated_preflight_emits_redacted_hermes_event(monkeypatch):
    ...
    emitted = []
    monkeypatch.setattr("distr.core.orchestrator.emit_event", lambda **kwargs: emitted.append(kwargs) or 901)
