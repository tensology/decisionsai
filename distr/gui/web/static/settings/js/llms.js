...
function openOllamaModelBrowser(type) {
    ...
    if (titleEl) {
        const typeLabels = { conversational: 'Conversational', coding: 'Coding', vision: 'Vision', image: 'Image', step_runner: 'Workflow', computer_use: 'Computer Use', kanban: 'Ticket Board Agent' };
