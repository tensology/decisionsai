"""Orchestrator memory and quiet activity API routes."""
...
def create_routes() -> APIRouter:
    ...
    @router.get("/orchestrator/memories")
    ...
    @router.post("/orchestrator/memories")
    ...
    @router.patch("/orchestrator/memories/{memory_uid}")
    async def patch_memory(memory_uid: str, request: MemoryPatchRequest):
        try:
            from distr.core.orchestrator_memory import set_user_memory_enabled
    ...
    @router.post("/orchestrator/activity/compact")
    async def compact_activity(request: ActivityCompactRequest):
        try:
            from distr.core.orchestrator_memory import compact_machine_activity, run_weekly_machine_activity_compaction
