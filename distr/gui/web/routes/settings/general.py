...
def register_routes(router, templates):
    ...
    async def get_general_settings():
        ...
        return JSONResponse({
            ...
            "default_project_editor": settings.get("default_project_editor", "codex"),
            ...
            "openai_tts_model": settings.get("openai_tts_model", "tts-1"),
            "openai_tts_instructions": settings.get("openai_tts_instructions", "") or "",
            "elevenlabs_tts_model": settings.get("elevenlabs_tts_model", "eleven_flash_v2_5"),
