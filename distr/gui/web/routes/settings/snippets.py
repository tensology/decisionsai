...
def _reserved_shortcut_signatures(settings: dict) -> dict[tuple[tuple[str, ...], str], str]:
    ...
    _add("Chat launcher", settings.get("web_hotkey_chat_modifier", "control_shift"), settings.get("web_hotkey_chat_key", "c"))
    _add("Projects launcher", settings.get("web_hotkey_projects_modifier", "control_shift"), settings.get("web_hotkey_projects_key", "j"))
    _add("Actions launcher", settings.get("web_hotkey_actions_modifier", "control_shift"), settings.get("web_hotkey_actions_key", "a"))
    _add("Snippets launcher", settings.get("web_hotkey_snippets_modifier", "control_shift"), settings.get("web_hotkey_snippets_key", "n"))
