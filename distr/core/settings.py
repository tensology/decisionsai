...
DEFAULT_SETTINGS = {
    ...
    'kanban_cli_tool': '',
    'kanban_cli_auth': '',
    'project_cli_low_backend': 'cursor',
    'project_cli_low_model': 'auto',
    'project_cli_low_model_provider': '',
    'project_cli_medium_backend': 'codex',
    'project_cli_medium_model': 'auto',
    'project_cli_medium_model_provider': '',
    'project_cli_high_backend': 'codex',
    'project_cli_high_model': 'gpt-5.3-codex',
    'project_cli_high_model_provider': '',
    'project_cli_low_codex_intelligence': '',
    'project_cli_low_codex_speed': '',
    'project_cli_medium_codex_intelligence': '',
    'project_cli_medium_codex_speed': '',
    'project_cli_high_codex_intelligence': '',
    'project_cli_high_codex_speed': '',
    ...
    'ticket_dictation_hotkey_enabled': HOTKEY_DEFAULTS['ticket_dictation_hotkey_enabled'],
    'ticket_dictation_hotkey_modifier': HOTKEY_DEFAULTS['ticket_dictation_hotkey_modifier'],
    'ticket_dictation_hotkey_key': HOTKEY_DEFAULTS['ticket_dictation_hotkey_key'],
