...
def is_hermes_validator_second_pass_enabled() -> bool:
    try:
        from distr.core.settings import load_settings_from_db

        settings = load_settings_from_db()
        return bool(settings.get("hermes_validator_second_pass_enabled", True))
    except Exception:
        return True
...
def run_hermes_validator_judgment(
    *,
    result: str,
    ...
    try:
        ...
        provider, model = get_hermes_role_model("validator")
...
def apply_hermes_validator_overlay(
    *,
    step: Any,
    result: str,
    caller_passed: bool,
    ...
    """
    if not is_hermes_validator_second_pass_enabled():
        return None
