...
def build_tools_description(tools: List) -> str:
    ...
    categories = {
        ...
        'INTEGRATIONS': ['send_file_to_telegram', 'send_voice_note_to_telegram', 'git_operations', 'create_ticket', 'create_cursor_ticket', 'google_workspace', 'markdown_to_google_doc', 'upload_doc_to_google', 'playwright_browser'],
