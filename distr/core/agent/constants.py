...
try:
    ...
    _ollama_rec = {"conversational": "ornith:9b", "coding": "ornith:9b", "vision": "qwen3-vl:235b-cloud"}
...
VAD_START_SECS = 0.1
VAD_BARGEIN_MULTIPLIER_MIN = 1.3
VAD_BARGEIN_MULTIPLIER_MAX = 2.3
VAD_BARGEIN_FLOOR_MIN = 0.02
VAD_BARGEIN_FLOOR_MAX = 0.06
VAD_BARGEIN_CONSECUTIVE_MIN = 6
