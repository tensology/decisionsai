...
class HermesDelegatedWorkflowInput(BaseModel):
    text: str = Field(description="The full user request to compile into a delegated Hermes workflow plan.")
...
class HermesDelegatedWorkflowTool(BaseTool):
    """Create and record a Hermes delegated workflow plan from a remote instruction."""

    name: str = "hermes_delegated_workflow"
    description: str = (
    ...
    args_schema: type[BaseModel] = HermesDelegatedWorkflowInput
    ...
    def _run(
        ...
        **_: object,
        ...
        from distr.core.hermes_delegated.events import record_delegated_plan
        ...
        if preflight:
            ...
            from distr.core.hermes_delegated.preflight import format_preflight_for_telegram, preflight_delegated_plan
        ...
        if execute:
            from distr.core.hermes_delegated.events import record_delegated_run_report
            from distr.core.hermes_delegated.roadblocks import format_run_report_for_telegram
...
def _default_runner():
    from distr.core.hermes_delegated.adapters import (
