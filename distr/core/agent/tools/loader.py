...
TOOL_REGISTRY = {
    ...
    "OrchestratorQualificationTool": ("system.orchestrator_qualification", "OrchestratorQualificationTool"),
...
TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "OrchestratorQualificationTool": "Report orchestrator production readiness, autonomy evidence, acceptance scenarios, and capability-specific provider/model certification.",
