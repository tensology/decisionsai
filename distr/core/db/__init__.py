...
class Settings(Base):
    ...
    elevenlabs_tts_model = Column(String, default='eleven_flash_v2_5')
    openai_voice = Column(String, default='alloy')
    openai_tts_model = Column(String, default='tts-1')
    openai_tts_instructions = Column(String, default='')
    openai_stt_prompt = Column(String, default='')
    openai_stt_noise_reduction = Column(String, default='')
