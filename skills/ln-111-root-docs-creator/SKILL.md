...
description: "Creates 5 root documentation files (PROJECT.md, docs/README.md, documentation_standards.md, principles.md, tools_config.md)."
license: MIT
---
...
|------|-----------------|-----------|
| PROJECT.md | Critical Rules, Documentation Navigation, Development Commands, Maintenance | Q1-Q6 |
...
For each document (PROJECT.md, docs/README.md, documentation_standards.md, principles.md):
...
3. If not exists:
   ...
   - **Detect available tools** (replace placeholders with actual values):
     - Task Management: use your project management tool to set Provider/Status/Project ID (auto-discovered)
...
```json
{
  "created": ["PROJECT.md", "docs/README.md", ...],
  "skipped": [],
  "tbd_count": 3,
  "validation": "OK"
}
