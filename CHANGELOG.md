...
The web interface is where you look after projects, tickets, workflows, and completed runs. You do not need to watch it while the agent works. Telegram gives you access to the same agent from your phone, so a message, voice note, screenshot, document, approval, or correction can stay connected to the job you started on your computer.
...
DecisionsAI is trying to make this a normal way to work. Send something in, let the right tools handle it, and come back to a result with a history you can inspect. It is moving toward doing more without supervision, but it should still show what happened and ask for your decision when it matters.
